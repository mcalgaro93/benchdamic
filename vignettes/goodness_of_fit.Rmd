...
```{r plot16S, fig.width=12, fig.height=7}
...
```{r plot16S_collapsed, fig.width=8, fig.height=5}
...
```{r plotWMS, fig.width=12, fig.height=7}
cowplot::plot_grid(plotlist = list(MDPlot(data = df_WMS,difference = "MD"),
MDPlot(data = df_WMS,difference = "ZPD")),
nrow = 2)
```

Also available in the other layout:

```{r plotWMS_collpased, fig.width=10, fig.height=5}
cowplot::plot_grid(plotlist = list(MDPlot(data = df_WMS,difference = "MD",split = FALSE),
MDPlot(data = df_WMS,difference = "ZPD",split = FALSE)),
nrow = 1)
```
