...
concordance_alternative <- createConcordance(
    ...
    colName = c("logFC", "log2FoldChange", "logFC", 
        ...
        "coef", # "importance", # mixMC
        "effect", "logFC"),
    type = c("logfc", "logfc", "logfc", "logfc", 
        "logfc", "pvalue", "logfc", "logfc", "logfc", 
        #"logfc", # mixMC
        "logfc", "logfc")
)
```
...
enrichment_nodir <- createEnrichment(
    ...
    threshold_pvalue = c(
        ...
        0.1, 0.1, # 0.1, # mixMC
        0.1, 0.1, 0.1, 0.1), # thresholds for other methods
    threshold_logfc = 0,
    top = NULL,
    alternative = "greater",
    verbose = FALSE
