...
concordance_alternative <- createConcordance(
    ...
    colName = c("logFC", "log2FoldChange", "logFC", 
        "effect", "logFC", "rawP", "W", "log2FoldChange", "logFC"),
...
enrichment_nodir <- createEnrichment(
    ...
    threshold_pvalue = c(
        ...
        rep(0.1,6)), # adjP thresholds for other methods
    threshold_logfc = 0,
    top = NULL,
    alternative = "greater",
    verbose = FALSE
