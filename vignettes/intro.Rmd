...
For the *HURDLE_default* model, a quite different range of values of mean differences is displayed because of the excessive 'default' (1 million) scaling proposed. It is also possible to plot only a subset of the estimated models:
...
```{r plotGOF_MD_collapsed, fig.width=5, fig.height=10}
...
```{r plotGOF_RMSE, fig.width=5,fig.height=10}
