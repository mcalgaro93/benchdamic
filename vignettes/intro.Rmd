...
-   `corncob` (temporarily removed from CRAN) with a focus on average differences (not dispersion, regulated by *phi.formula* and *phi.formula_null* parameters) using both *Wald* and *LRT* tests [@corncob];
...
# Temporarily removed (v2.3.2 crashes R)
# # Very time consuming
# my_ANCOM <- set_ANCOM(
#     pseudo_count = FALSE,
#     adj_formula = NULL,
...
my_methods_noWeights <- c(
    ...
    my_MAST,
    my_dearseq,
    # my_ANCOM, # Temporary bug with random effects
    my_linda,
    my_Maaslin2,
